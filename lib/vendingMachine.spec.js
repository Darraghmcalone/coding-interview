        ...
        describe('when product name exists', () => {
            ...
            describe('and product has sufficient quantity', () => {
                describe('and insufficient coins provided', () => {
                    it('should return false', () => {
                        testVendingMachine.inventory[0].value = 1;
                        const testCoinsTendered = [{
                            name: "twenty pence",
                            value: 0.20,
                        }];
                ...
                describe('and sufficient coins provided', () => {
                    it('should return true', () => {
                        ...
                        const actualResult = testVendingMachine.dispenseProduct('twix', testCoinsTendered);
                        expect(actualResult).toEqual(true);
                    });
                });
                describe('and more coins have been provided ()', () => {
                    it('should return true', () => {
                        const testCoinsTendered = [
                            {
                                name: "one pound",
